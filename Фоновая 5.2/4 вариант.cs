...
namespace Вариант_4
{
    ...
    class SuperClass
    {
        ...
        public virtual string ClassName { get { return "SuperClass";  } }
    }
    class Creature : SuperClass
    {
        ...
        public virtual void Move(string direction, Field field)
        {
            Console.WriteLine();
        }
        ...
        public override string ClassName { get { return "Creature";  } }
    }
