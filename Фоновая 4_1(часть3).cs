...
namespace Вариант8
{
    class Parallelepiped
    {
        ...
        Parallelepiped(int h, int sh, int g, int x, int y)
        {
            this.h = h;
            this.sh = sh;
            this.g = g;
        ...
        public int H
        {
            ...
            set
            {
                try
                {
                    ...
                    {
                        h = 5;
                        throw new Exception("Высота не может быть отрицательной! Ставлю значение по умолчанию, равное 5");
                    }
                    else h = value;
                }
                catch (Exception err)
        ...
        public int SH
        {
            ...
            set
            {
                try
                {
                    ...
                    {
                        sh = 6;
                        throw new Exception("Ширина не может быть отрицательной! Ставлю значение по умолчанию, равное 6");
                    }
                    else sh = value;
                }
                catch (Exception err)
        ...
        public int G
        {
            ...
            set
            {
                try
                {
                    ...
                    {
                        g = 7;
                        throw new Exception("Ширина не может быть отрицательной! Ставлю значение по умолчанию, равное 7");
                    }
                    else g = value;
                }
                catch (Exception err)
